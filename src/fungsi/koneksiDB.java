...
public class koneksiDB {
    ...
    public static String URLAPISIRSC19(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("URLAPISIRSC19");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String IDSIRSC19(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("IDSIRSC19"));
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String PASSSIRSC19(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("PASSSIRSC19"));
        }catch(Exception e){
            var=""; 
        }
        return var;
